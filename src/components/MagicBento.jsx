...
const cardData = [
  {
    ...
    description:
      "High-quality renders of building exteriors for presentations and marketing.",
    label: "Exteriors",
  },
  {
    color: "#060010",
    ...
    description:
      "Realistic interior renderings that capture lighting, materials, and ambiance.",
    label: "Interiors",
  },
  {
    color: "#060010",
    title: "Architectural Animation",
    description: "Animated walkthroughs that bring your projects to life.",
    label: "Animation",
  },
  {
    color: "#060010",
    title: "Virtual Reality Tours",
    description: "Immersive VR experiences to explore designs in real-time.",
    label: "VR",
  },
  {
    color: "#060010",
    title: "Concept Design",
    description: "Creative 3D concepts to visualize ideas before construction.",
    label: "Concepts",
  },
  {
    color: "#060010",
    title: "Post-Production & Effects",
    description:
      "Enhance renders with lighting, materials, and cinematic effects.",
